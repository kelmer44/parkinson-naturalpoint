...
void J_Enviar::setHost( const char *hostname )
{
    struct hostent *h;
...
void J_Enviar::setPort( const short port )
{
    _port = port;
}

void J_Enviar::setBuffer( void *buffer, const unsigned int size )
{
    _buffer = buffer;
    _buffer_size = size;
}

bool J_Enviar::sync( void )
{
